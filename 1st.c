...
void sort(double arr[],int low,int high)         // quick-sort function
{
    if (low < high)  
    {  
...
void main(){
    ...
    printf("        Welcome to First Price Auction      \n");
    ...
    printf("First Price Auction bid will be:\n");
    for(int i =0; i<NoP; i++){
        bidarr[i] = bidFun * valarr[i];
